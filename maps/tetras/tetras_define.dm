/datum/map/tetras
	name = "Tetras Star-7 Outpost"
	full_name = "Tetras Outpost"
	path = "tetras"
	flags = MAP_HAS_BRANCH | MAP_HAS_RANK

	lobby_icon = 'maps/tetras/icons/lobby.dmi'
	...
	base_turf_by_z = list("1" = /turf/unsimulated/planet)
	usable_email_tlds = list("torch.ec.scg", "torch.fleet.mil", "torch.marine.mil", "freemail.nt")

	allowed_spawns = list("Cryogenic Storage", "Cyborg Storage")
	default_spawn = "Cryogenic Storage"

	station_name  = "Tetras Outpost"
	station_short = "Tetras"
	dock_name     = "TBD"
	boss_name     = "Tetras Republic"
	boss_short    = "Command"
	...
	shuttle_docked_message = "Attention: work shift ending in %ETD%."
	shuttle_leaving_dock = "Attention: work shift has ended."
	shuttle_called_message = "Attention all hands: Jump sequence initiated. Transit procedures are now in effect. Jump in %ETA%."
	shuttle_recall_message = "Attention: work shift has been extended. Continue the normal working operation."
...
/datum/map/tetras/send_welcome()
	var/welcome_text = "<center><img src = sollogo.png /><br /><font size = 3><b>Tetras</b> Sensor Readings:</font><hr />"
	...
	post_comm_message("Tetras Sensor Readings", welcome_text)
	minor_announcement.Announce(message = "New [GLOB.using_map.company_name] Update available at all communication consoles.")



/datum/map/tetras/perform_map_generation()
