...
/mob/living/carbon/human/handle_vision()
	if(client)
		client.screen.Remove(GLOB.global_hud.nvg,GLOB.global_hud.sovnvg,GLOB.global_hud.natonvg, GLOB.global_hud.thermal, GLOB.global_hud.meson, GLOB.global_hud.science)
	if(machine)
